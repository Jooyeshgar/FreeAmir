...
**امیر** یک نرم‌افزار حسابداری آزاد و رایگان مبتنی بر Laravel است که برای کسب‌وکارهای ایرانی طراحی شده است. تمرکز پروژه روی حسابداری دوبل، فاکتور فروش و خرید، مدیریت کالا و بهای تمام‌شده، عملیات سال مالی، حضور و غیاب، و حقوق و دستمزد است.
