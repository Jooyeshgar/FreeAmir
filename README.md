...
**امیر** یک نرم‌افزار متن باز حسابداری و ERP برای کسب‌وکارهای ایرانی است. تمرکز پروژه روی حسابداری دوبل، فاکتور فروش و خرید، مدیریت کالا و بهای تمام‌شده، عملیات سال مالی، حضور و غیاب، حقوق و دستمزد، و انطباق با الزامات مالیاتی ایران از جمله سامانه مودیان است.
...
بله. امیر برای سلف‌هاستد طراحی شده و داده‌ها کاملا در اختیار شماست.
