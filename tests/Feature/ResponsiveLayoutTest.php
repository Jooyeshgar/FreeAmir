...
class ResponsiveLayoutTest extends TestCase
{
    ...
    public function test_workspace_layout_has_mobile_navigation_and_a_fluid_container(): void
    {
    ...
    public function test_management_layout_has_an_off_canvas_mobile_sidebar(): void
    {
        $user = User::factory()->create();
        ...
        $this->actingAs($user)
            ...
            ->assertOk()
            ->assertSee('management-sidebar', false)
            ->assertSee('sidebarOpen=true', false)
