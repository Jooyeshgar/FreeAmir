...
| صفحه | توضیح |
|---|---|
| [ویژگی‌ها](features.md) | فهرست کامل قابلیت‌های امیر |
| [مقایسه](comparison.md) | مقایسه با نرم‌افزارهای تجاری |
| [سوالات متداول](faq.md) | پاسخ به سوالات رایج |
| [نقشه راه](roadmap.md) | نقشه راه توسعه آینده |
| [نمایشگاه](screenshots.md) | تصاویر محیط کاربری |
| [سامانه مودیان](moadian.md) | راهنمای راه‌اندازی سامانه مودیان |
