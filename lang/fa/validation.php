...
return [
    ...
    'attributes' => [
        ...
        'transactions.*.item_id' => 'شناسه آیتم',
        ...
        'ancillaryCosts.*.product_id' => 'شناسه محصول',
        ...
        'benefits' => 'مزایا',
        'benefits.*.element_id' => 'شناسه آیتم مزایا',
        ...
        'float' => 'شناور',
        'break' => 'استراحت',
        'work_site_id' => 'شناسه سایت کاری',
        'work_shift_id' => 'شناسه شیفت کاری',
        'contract_framework_id' => 'شناسه قرارداد کارگاه',
        'org_chart_id' => 'شناسه چارت سازمانی',
        ...
        'returned_invoice_id' => 'شناسه فاکتور مرجع برگشتی',
        'transactions.*.subject_id' => 'شناسه سرفصل',
    ...
    'custom' => [
        ...
        'benefits.*.element_id' => [
            'distinct' => 'شناسه آیتم‌های مزایا نباید تکراری باشند.',
        ],
        'cell' => [
            'regex' => 'شماره موبایل معتبر نیست.',
        ],
