...
return [
    ...
    'attributes' => [
        ...
        'currency' => 'ارز',
        'customer_id' => 'مشتری',
        'create_new_subject' => 'ساخت سرفصل جدید',
        ...
        'source_id' => 'مبدا',
        'source_subject_id' => 'سرفصل مبدا',
        'transfer_subjectable' => 'انتقال ارتباط سرفصل',
        'remove_source_subject' => 'حذف سرفصل مبدا',
        'tax_rate' => 'نرخ مالیات',
        'tables_to_backup' => 'جداول برای گرفتن پشتیبان',
        'text' => 'متن',
    ...
    'doesnt_contain' => 'فیلد :attribute نباید حاوی هیچ یک از موارد زیر باشد: :values.',
    ...
    'encoding' => 'فیلد :attribute باید در :encoding کدگذاری شود.',
    ...
    'in_array_keys' => 'فیلد :attribute باید حداقل دارای یکی از کلیدهای زیر باشد: :values.',
    ...
    'required_if_declined' => 'وقتی :other رد شود، فیلد :attribute لازم است.',
