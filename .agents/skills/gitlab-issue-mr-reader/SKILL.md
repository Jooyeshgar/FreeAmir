...
- `GITLAB_GROUP_ID`: Numeric group ID or URL-encoded group path.
- `GITLAB_BOARD_ID`: Board ID for board-list lookup.
- `GITLAB_DOING_LABEL`: Label/list name that represents the Doing tab. Default to `Doing`.
