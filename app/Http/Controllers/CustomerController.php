...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'acc_name_1' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
            'acc_no_1' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
            'acc_bank_1' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
            'acc_name_2' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
            'acc_no_2' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
            'acc_bank_2' => 'required|string|max:50|regex:/^[\w\d\s]*$/u',
        ]);
