...
| **Inventory** | Warehouse management, inter-warehouse transfers, stock tracking, weighted average costing |
...
### 1. Single Docker command (quick testing)
...
|---|---|---|
| Features | [features.html](docs/features.html) | [features.en.html](docs/features.en.html) |
| Comparison | [comparison.html](docs/comparison.html) | [comparison.en.html](docs/comparison.en.html) |
| FAQ | [faq.html](docs/faq.html) | [faq.en.html](docs/faq.en.html) |
| Roadmap | [roadmap.html](docs/roadmap.html) | [roadmap.en.html](docs/roadmap.en.html) |
| Screenshots | [screenshots.html](docs/screenshots.html) | [screenshots.en.html](docs/screenshots.en.html) |
