...
class AttendanceLogDemoSeeder extends Seeder
{
    /**
     * Seed three months of attendance logs for each demo employee.
     *
     * Iran's working week ends on Thursday and Friday is the weekly off-day.
     * We generate one log per calendar day (including Fridays, marked accordingly)
     * with realistic entry/exit times. `worked` is stored in minutes — the demo
     * shift is 08:00–16:00 (480 minutes).
     */
    ...
    private function createLog(Employee $employee, Carbon $date): void
    {
        ...
        // Skip Fridays as actual work, but still record the day with no worked time.
        $worked = $isFriday ? 0 : 480;
        $entry = $isFriday ? null : '08:00:00';
        $exit = $isFriday ? null : '16:00:00';

        // Lightly randomize delay / overtime for non-Friday days.
