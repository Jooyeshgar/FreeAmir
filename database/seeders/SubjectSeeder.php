...
class SubjectSeeder extends Seeder
{
    ...
    {
        $subjectData = [
            ['id' => 1, 'code' => '010', 'name' => 'بانکها', 'parent_id' => null, '_lft' => 1, '_rgt' => 2, 'type' => 'both'],
            ['id' => 2, 'code' => '040', 'name' => 'هزینه ها', 'parent_id' => null, '_lft' => 3, '_rgt' => 28, 'type' => 'debtor'],
            ['id' => 3, 'code' => '011', 'name' => 'موجودیهای نقدی', 'parent_id' => null, '_lft' => 29, '_rgt' => 32, 'type' => 'both'],
            ['id' => 4, 'code' => '012', 'name' => 'بدهکاران/بستانکاران', 'parent_id' => null, '_lft' => 33, '_rgt' => 34, 'type' => 'both'],
            ['id' => 6, 'code' => '013', 'name' => 'اسناد دریافتنی', 'parent_id' => null, '_lft' => 39, '_rgt' => 42, 'type' => 'both'],
            ...
            ['id' => 67, 'code' => '014', 'name' => 'اسناد در جریان وصول', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ['id' => 68, 'code' => '014001', 'name' => 'اسناد در جریان وصول', 'parent_id' => 67, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ['id' => 69, 'code' => '015', 'name' => 'موجودی مواد و کالا', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ...
            ['id' => 71, 'code' => '016', 'name' => 'پیش پرداخت ها', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ...
            ['id' => 75, 'code' => '017', 'name' => 'دارایی های غیر جاری', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ...
            ['id' => 38, 'code' => '018', 'name' => 'سایر حسابهای دریافتنی', 'parent_id' => null, '_lft' => 89, '_rgt' => 94, 'type' => 'both'],
            ...
            ['id' => 22, 'code' => '020', 'name' => 'اسناد پرداختنی', 'parent_id' => null, '_lft' => 65, '_rgt' => 68, 'type' => 'both'],
            ['id' => 46, 'code' => '020001', 'name' => 'اسناد پرداختنی', 'parent_id' => 22, '_lft' => 66, '_rgt' => 67, 'type' => 'both'],
            ['id' => 81, 'code' => '022', 'name' => 'پیش دریافت ها', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ...
            ['id' => 39, 'code' => '023', 'name' => 'سایر حسابهای پرداختنی', 'parent_id' => null, '_lft' => 95, '_rgt' => 100, 'type' => 'both'],
            ...
            ['id' => 84, 'code' => '030', 'name' => 'حقوق صاحبان سهام', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ...
            ['id' => 88, 'code' => '041', 'name' => 'قیمت تمام شده کالای فروش رفته', 'parent_id' => null, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ['id' => 89, 'code' => '041001', 'name' => 'قیمت تمام شده کالای فروش رفته', 'parent_id' => 88, '_lft' => 30, '_rgt' => 31, 'type' => 'both'],
            ['id' => 23, 'code' => '050', 'name' => 'درآمدها', 'parent_id' => null, '_lft' => 69, '_rgt' => 76, 'type' => 1],
            ['id' => 36, 'code' => '050001', 'name' => 'درآمد متفرقه', 'parent_id' => 23, '_lft' => 74, '_rgt' => 75, 'type' => 1],
            ['id' => 18, 'code' => '060', 'name' => 'فروش', 'parent_id' => null, '_lft' => 57, '_rgt' => 60, 'type' => 1],
            ['id' => 20, 'code' => '060001', 'name' => 'فروش', 'parent_id' => 18, '_lft' => 58, '_rgt' => 59, 'type' => 1],
            ['id' => 25, 'code' => '061', 'name' => 'برگشت از فروش و تخفیفات', 'parent_id' => null, '_lft' => 83, '_rgt' => 88, 'type' => 'both'],
            ...
            ['id' => 17, 'code' => '062', 'name' => 'خرید', 'parent_id' => null, '_lft' => 53, '_rgt' => 56, 'type' => 'debtor'],
            ['id' => 19, 'code' => '062001', 'name' => 'خرید', 'parent_id' => 17, '_lft' => 54, '_rgt' => 55, 'type' => 'debtor'],
            ['id' => 24, 'code' => '063', 'name' => 'برگشت از خرید و تخفیفات', 'parent_id' => null, '_lft' => 77, '_rgt' => 82, 'type' => 'both'],
            ...
            ['id' => 90, 'code' => '064', 'name' => 'حسابهای انتظامی', 'parent_id' => null, '_lft' => 80, '_rgt' => 81, 'type' => 'both'],
            ...
            ['id' => 93, 'code' => '065', 'name' => 'طرف حسابهای انتظامی', 'parent_id' => null, '_lft' => 80, '_rgt' => 81, 'type' => 'both'],
            ...
            ['id' => 97, 'code' => '066', 'name' => 'تخفیفات نقدی', 'parent_id' => null, '_lft' => 80, '_rgt' => 81, 'type' => 'both'],
            ['id' => 98, 'code' => '066001', 'name' => 'تخفیفات نقدی', 'parent_id' => 97, '_lft' => 80, '_rgt' => 81, 'type' => 'both'],
            ['id' => 5, 'code' => '067', 'name' => 'تراز افتتاحیه', 'parent_id' => null, '_lft' => 35, '_rgt' => 38, 'type' => 'both'],
            ['id' => 15, 'code' => '067001', 'name' => 'تراز افتتاحیه', 'parent_id' => 5, '_lft' => 36, '_rgt' => 37, 'type' => 'both'],
            ['id' => 8, 'code' => '068', 'name' => 'جاری شرکا', 'parent_id' => null, '_lft' => 47, '_rgt' => 50, 'type' => 'both'],
            [
                'id' => 37,
                'code' => '068001',
                'name' => 'جاری شرکا',
