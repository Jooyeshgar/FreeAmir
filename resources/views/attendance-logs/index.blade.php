    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            ...
            <div class="flex items-center justify-end gap-2">
                @can('attendance.attendance-logs.bulk-create')
                    <a href="{{ route('attendance.attendance-logs.bulk-create') }}" class="btn btn-sm btn-outline btn-accent" title="{{ __('Bulk Create Attendance Logs') }}">
