<div class="selfSelectBoxContainer relative flex-1 min-w-80 max-w-80 pb-3" onclick="openSelectBox(this)">
    ...
    <div class="selfSelectBox hidden absolute z-[3] top-[40px] w-full h-[300px] bg-white overflow-auto px-4 pb-4 rounded-[16px] shadow-[0px_43px_27px_0px_#00000012]">
        <div class="sticky top-0 left-0 right-0 w-full bg-white py-2">
            <div class="relative">
                <x-text-input name="" value="" label_text_class="text-gray-500" label_class="w-full" input_class="pe-8 text-sm"
                            ...
                            <div class="ps-1 mt-4">
                                <div class="border-s-[1px] ps-4 border-[#ADB5BD]">
                                    @foreach ($subject->children as $children)
                                        <a href="javascript:void(0)" class="selfSelectBoxItems flex justify-between" onclick="fillInput(this, '0')">
