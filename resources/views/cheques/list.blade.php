<x-app-layout>
    ...
    <div class="card bg-base-100">
        <div class="card-body">
            ...
            <form action="{{ route('cheques.list') }}" method="GET">
                <div class="mt-4 mb-4 grid grid-cols-8 gap-4">
                    ...
                    <div class="col-span-4 md:col-span-2">
                        <input type="text" name="cheque_book_title" value="{{ request('cheque_book_title') }}"
                            placeholder="{{ __('Cheque Book Title') }}"
                            class="w-full pl-8 pr-2 py-2 text-sm rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-500 focus:border-blue-500" />
                    </div>
