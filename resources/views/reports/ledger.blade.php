<x-app-layout :title="__('General Journal Report')">
    ...
    <form id="ledger-report-form" action="{{ route('reports.result') }}" method="get">
        ...
        <div class="mt-2 flex gap-2 justify-end">
            <x-form-export-delivery-choice id="ledger-report-delivery" form="ledger-report-form" export="accounting_report_csv" class="btn btn-default rounded-md" />
