<article class="company-overview-chart card min-w-0 border border-base-300 bg-base-100/90 shadow-sm">
    <div class="card-body p-3 lg:p-4">
        <div class="flex flex-wrap items-start justify-between gap-2">
            <div>
                <h2 class="card-title text-sm leading-5 lg:text-base lg:leading-normal">{{ __('Bank Account Balance') }}</h2>
        ...
        function bankSelectHandler() {
            return {
                ...
                handleBankChange() {
                    ...
                    try {
                        const route = "{{ route('reports.company-overview.bank-account') }}";
