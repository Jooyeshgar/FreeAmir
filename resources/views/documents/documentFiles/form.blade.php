<div class="grid grid-cols-2 gap-4">
    ...
    <div class="col-span-2 md:col-span-1 w-64 max-w-md">
        <x-input type="file" name="file" title="{{ __('File') }} ({{ __('Image') }} {{ __('or') }} {{ __('PDF') }})" accept="image/*,application/pdf"
            :bordered="false" :required="!isset($documentFile) || !$documentFile->exists || !$documentFile->path"
