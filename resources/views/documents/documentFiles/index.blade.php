    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            ...
            <div class="card-actions flex justify-between gap-4 ">
                <a href="{{ route('documents.files.create', $document->id) }}" class="btn btn-primary ">{{ __('Add Document File') }}</a>
            </div>
                    ...
                    @foreach ($documentFiles as $documentFile)
                        <tr>
                            ...
                            <td class="px-4 py-2 flex gap-2 items-center">
                                <a href="{{ route('documents.files.view', [$document, $documentFile]) }}" class="btn btn-sm btn-info btn-square"
                                    title="{{ __('View') }}">
                                ...
                                <a href="{{ route('documents.files.download', [$document, $documentFile]) }}" class="btn btn-sm btn-info btn-square"
                                    title="{{ __('Download') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <a href="{{ route('documents.files.edit', [$document, $documentFile]) }}" class="btn btn-sm btn-info btn-square"
                                    title="{{ __('Edit') }}">
                                ...
                                <form action="{{ route('documents.files.destroy', [$document->id, $documentFile]) }}" method="POST" class="m-0"
