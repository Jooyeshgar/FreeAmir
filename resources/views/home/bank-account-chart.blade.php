    <div class="w-1/2 max-[1200px]:w-full bg-[#E9ECEF] rounded-[16px]">
        <div class="flex justify-between items-center max-[850px]:flex-col max-[850px]:mt-4">
            ...
            <div class="flex m-2 overflow-hidden" x-data="bankSelectHandler()" x-init="initializeBank()">
                <select class="select bg-[#DEE2E6] text-[#495057] ml-2" x-model="selectedBankAccount" @change="handleBankChange">
                ...
                <select x-model="selectedDuration" @change="handleBankChange" class="select bg-[#DEE2E6] text-[#495057]">
