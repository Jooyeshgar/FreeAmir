            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                ...
                <div class="card bg-base-200 shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="text-2xl font-bold transition-colors duration-300 text-sky-500" title="{{ __('Last Cost Of Goods') }}">
                ...
                <div class="card bg-base-200 shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="text-2xl font-bold transition-colors duration-300 text-green-700" title="{{ __('Sale Profit') }}">
