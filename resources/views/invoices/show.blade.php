                ...
                <div class="flex flex-wrap gap-2">
                    @can('invoices.transfer')
                        @if ($fiscalYears->isNotEmpty())
                            <button type="button" onclick="document.getElementById('inv-transfer-modal').showModal()" class="btn gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <dialog id="inv-transfer-modal" class="modal">
                <div class="modal-box">
                    ...
                    <form action="{{ route('invoices.transfer', $invoice) }}" method="POST" class="mt-4">
                        ...
                        <div class="modal-action">
                            <button type="button" onclick="document.getElementById('inv-transfer-modal').close()" class="btn">{{ __('Cancel') }}</button>
