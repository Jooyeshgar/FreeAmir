                            ...
                            <td class="px-4 py-2">
                                ...
                                @can('invoices.approve')
                                    @php
                                        ...
                                        $tooltip = $changeStatusValidation->hasMessage()
                                            ? 'data-tip="' . e($changeStatusValidation->toText()) . '"'
                                            : '';
                                    @endphp
                                    ...
                                    @else
                                        <a {!! $tooltip !!}
                                            href="{{ route('invoices.change-status', [$invoice, $isApproved ? 'unapproved' : 'approved']) }}"
