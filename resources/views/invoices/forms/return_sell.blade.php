            ...
            <div class="flex-wrap w-full" x-data="{
                ...
                <div class="flex items-center justify-between gap-2">
                    ...
                    <x-checkbox title="{{ __('Include last years invoices') }}" name="includeLastYears"
                        id="include-last-years-return-sell" x-model="includeLastYears" x-bind:disabled="@js($disableReturnedInvoiceSelect)" />
                </div>
                ...
                <div x-show="includeLastYears">
                    <x-select-box url="{{ route('invoices.search', ['invoice_type' => 'return_sell:1:'.implode(',', $accessibleCompanyIds ?? [])]) }}"
...
<div class="mt-4 flex gap-2 justify-end">
    <a href="{{ route('invoices.index', ['invoice_type' => 'return_sell']) }}" type="submit"
